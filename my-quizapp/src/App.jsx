...
function App() {
  ...
  <body className="bg-black">
    <section className="bg-stone-950 m-2">
      <div
        className="w-[80vw] h-[50vh] border rounded-lg border-yellow-300 mx-auto my-0"
        style={{
      ...
      <div className="w-[100vw] h-[auto] border-yellow-300 shadow-md border mt-5 mx-4 my-0 rounded-xl"
              style={{
                backgroundImage: `url(${quizImage})`,
                backgroundSize: "cover",
                backgroundRepeat: "no-repeat",
