    ...
    <div class="flex flex-wrap -m-4">
      <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div class="h-full bg-white rounded-lg shadow-md text-center p-6">
          ...
          <button class="button-85" role="button">
            <Link class='quizbutton' to='/GeneralQuestion'>Start</Link></button>
        </div>
      </div>
      <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div class="h-full bg-white rounded-lg shadow-md text-center p-6">
          ...
          <button class="button-85" role="button">
            <Link class='quizbutton' to='/NatureQuestion'>Start</Link></button>
        </div>
      </div>
      ...
      <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div class="h-full bg-white rounded-lg shadow-md text-center p-6">
          ...
          <button class="button-85" role="button">
            <Link class='quizbutton' to='/GeographyQuestion'>Start</Link></button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="flex flex-wrap -m-4">
      <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div class="h-full bg-white rounded-lg shadow-md text-center p-6">
          ...
          <button class="button-85" role="button">
            <Link class='quizbutton' to='/SportQuestion'>Start</Link></button>
        </div>
      </div>
      <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div class="h-full bg-white rounded-lg shadow-md text-center p-6">
          ...
          <button class="button-85" role="button">
          <Link class='quizbutton' to='/Question'>Start</Link></button>
        </div>
      </div>
      <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div class="h-full bg-white rounded-lg shadow-md text-center p-6">
          ...
          <button class="button-85" role="button">
            <Link class='quizbutton' to='/EntertainmentQuestion'>Start</Link></button>
