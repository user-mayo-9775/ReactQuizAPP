  ...
  if (loading) {
    return (
      ...
      <div id='miancard' className='w-full max-w-lg bg-white rounded-lg shadow-lg p-6' style={{
        ...
        <i>Car Questions</i>
        <i className='text-yellow-300 text-3xl'><span className='text-white text-sm'></span> <FontAwesomeIcon icon={faSquareXmark}/><span className='text-white'>{falseanswer}</span></i>
        </div>
